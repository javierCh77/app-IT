...
//icons
import files1 from "../assets/icons/files1.svg";
...
const Imagenes = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://10.27.64.211:3001/api/imagenes");
      ...
      <div className="">
        <div className="flex  md:flex-nowrap  gap-3 justify-between text-center items-center ">
          ...
          <input
            ...
            placeholder="Ingresa aquí el nombre de la imagen a buscar"
            ...
            {currentItems.map((item) => (
              ...
              >
                ...
                <td className="p-2">
                    ...
                    <button className="rounded hover:bg-[#a7b6fa]">
